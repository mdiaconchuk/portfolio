    ...
    return (
        <div id="intro">
            <div class="text-white py-5 w-100 text-dark bg-opacity-100 fw-bold">
                ...
                <p class="fs-4 my-5">Un desarrollador Front-End de <span class="text-info">Argentina</span>,<br /> que disfruta crear aplicaciones web simples y fáciles de usar.</p>
